...
import com.example.MiniSocialNetwork.facade.CommentFacade;
import com.example.MiniSocialNetwork.payload.response.MessageResponse;
import com.example.MiniSocialNetwork.services.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<Object> createComment(@Valid @RequestBody CommentDTO commentDTO,
        ...
        Comment comment = commentService.saveComment(Long.parseLong(postId), principal, commentDTO);
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentsToPost(@PathVariable("postId") String postId) {
        List<CommentDTO> commentDTOList = commentService.getAllByPost(Long.parseLong(postId))
                .stream()
